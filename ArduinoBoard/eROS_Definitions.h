...
#define LEDPIXELMODE_COLORCYCLE 4
#define LEDPIXELMODE_FOCUS 5
//TAG: End LEDPixelMode

//TAG: Start LEDPixelColor
#define LEDPIXELCOLOR_OFF 0
#define LEDPIXELCOLOR_YELLOW 1
#define LEDPIXELCOLOR_RED 2
#define LEDPIXELCOLOR_GREEN 3
#define LEDPIXELCOLOR_PURPLE 4
#define LEDPIXELCOLOR_BLUE 5
#define LEDPIXELCOLOR_WHITE 6
