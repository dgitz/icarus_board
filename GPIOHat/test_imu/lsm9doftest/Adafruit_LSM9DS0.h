...
#define LSM9DS0_ADDRESS_ACCELMAG0           (0x1D)         // 3B >> 1 = 7bit default
#define LSM9DS0_ADDRESS_GYRO0               (0x6B)         // D6 >> 1 = 7bit default
#define LSM9DS0_ADDRESS_ACCELMAG1           (0x1E)         // 3B >> 1 = 7bit default
#define LSM9DS0_ADDRESS_GYRO1               (0x6A)         // D6 >> 1 = 7bit default
